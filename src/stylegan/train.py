...
if 1:
    ...
    desc += '-albums';      dataset = EasyDict(tfrecord_dir='album-covers');        train.mirror_augment = False
...
def main():
    ...
    kwargs.submit_config.run_dir_root = gan_streamer.dnnlib.submission.submit.get_template_from_path(config.result_dir)
